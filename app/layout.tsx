...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Chizz Cunningham | Tech Entrepreneur, Investor & Fractional CTO',
  ...
  openGraph: {
    title: 'Chizz Cunningham | Tech Entrepreneur, Investor & Fractional CTO',
    description: 'Tech entrepreneur, investor, and fractional CTO helping startups build and scale technology through Archatech Labs.',
