...
const ventures: Venture[] = [
  ...
  },
  {
    ...
    link: 'https://www.oatmealradiocafe.com',
    external: true,
  ...
  {
    name: 'SUPL',
    mission: 'AI-powered movement intelligence—assess, train, and recover smarter using only your phone.',
    differentiator: 'Camera-based pose analysis that measures mobility, stability, strength, and symmetry, then builds personalized programs for athletes, coaches, and clinicians.',
    credibility: 'AI + sports performance + rehab',
    link: 'https://www.getsupl.io',
    external: true,
    categories: ['AI', 'Consumer'],
    fullDescription:
      'SUPL (Movement Intelligence for Every Athlete) delivers camera-based movement analysis and personalized training powered by Sports Rehab LA. Assess mobility, strength, stability, and movement quality from a phone, then follow adaptive programs that update as your body improves—built for athletes, coaches, and clinicians across the Assess → Analyze → Prescribe → Train → Track loop.',
